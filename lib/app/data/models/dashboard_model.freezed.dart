...
mixin _$DashboardSummary {
  int get totalPresence => throw _privateConstructorUsedError;
  int get totalLearningActivities => throw _privateConstructorUsedError;
  int get totalPKLDays => throw _privateConstructorUsedError;
  double get presencePercentage => throw _privateConstructorUsedError;
...
class _$DashboardSummaryCopyWithImpl<$Res, $Val extends DashboardSummary>
  ...
  @override
  $Res call({
    Object? totalPresence = null,
    Object? totalLearningActivities = null,
    Object? totalPKLDays = null,
    Object? presencePercentage = null,
...
class _$DashboardSummaryImpl implements _DashboardSummary {
  ...
  @override
  final int totalLearningActivities;
  @override
  final int totalPKLDays;
  @override
  final double presencePercentage;
  @override
  final double learningProgress;
  @override
  final double pklProgress;

  @override
  String toString() {
    return 'DashboardSummary(totalPresence: $totalPresence, totalLearningActivities: $totalLearningActivities, totalPKLDays: $totalPKLDays, presencePercentage: $presencePercentage, learningProgress: $learningProgress, pklProgress: $pklProgress)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.presencePercentage, presencePercentage) ||
                other.presencePercentage == presencePercentage) &&
            (identical(other.learningProgress, learningProgress) ||
                other.learningProgress == learningProgress) &&
            (identical(other.pklProgress, pklProgress) ||
...
abstract class _DashboardSummary implements DashboardSummary {
  ...
  @override
  int get totalPresence;
  @override
  int get totalLearningActivities;
  @override
  int get totalPKLDays;
  @override
...
class _$RecentActivityImpl implements _RecentActivity {
  ...
  @override
  String toString() {
    return 'RecentActivity(id: $id, type: $type, title: $title, description: $description, timestamp: $timestamp, status: $status)';
  }
...
DashboardStatistics _$DashboardStatisticsFromJson(Map<String, dynamic> json) {
  return _DashboardStatistics.fromJson(json);
}

/// @nodoc
mixin _$DashboardStatistics {
  Map<String, int> get presenceByDay => throw _privateConstructorUsedError;
...
/// @nodoc
class _$DashboardStatisticsCopyWithImpl<$Res, $Val extends DashboardStatistics>
    implements $DashboardStatisticsCopyWith<$Res> {
  _$DashboardStatisticsCopyWithImpl(this._value, this._then);
...
class _$DashboardStatisticsImpl implements _DashboardStatistics {
  ...
  final Map<String, int> _presenceByDay;
  @override
  Map<String, int> get presenceByDay {
    if (_presenceByDay is EqualUnmodifiableMapView) return _presenceByDay;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_presenceByDay);
  }

  final Map<String, double> _learningScores;
  @override
  Map<String, double> get learningScores {
    if (_learningScores is EqualUnmodifiableMapView) return _learningScores;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_learningScores);
  }

  final Map<String, int> _pklActivities;
  @override
  Map<String, int> get pklActivities {
    if (_pklActivities is EqualUnmodifiableMapView) return _pklActivities;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_pklActivities);
  }

  @override
  String toString() {
    return 'DashboardStatistics(presenceByDay: $presenceByDay, learningScores: $learningScores, pklActivities: $pklActivities)';
  }
